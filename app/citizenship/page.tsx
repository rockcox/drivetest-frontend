    ...
    <div className="min-h-screen bg-paper flex flex-col">
      <nav className="border-b border-ink/8 sticky top-0 bg-paper/90 backdrop-blur-sm z-50">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center gap-2 text-sm">
          ...
          <span className="text-ink font-medium">Citizenship</span>
        </div>
      </nav>
      <div className="flex-1 flex items-center justify-center px-6 py-24">
        <div className="text-center max-w-sm w-full">
          <span className="text-3xl block mb-4">🍁</span>
          <h1 className="font-display text-4xl text-ink mb-4">Citizenship</h1>
          <p className="text-ink/45 text-sm leading-relaxed mb-10">
            We are building IRCC citizenship test and ceremony appointment booking. Leave your email and we will let you know when it is ready.
          </p>
          {submitted ? (
