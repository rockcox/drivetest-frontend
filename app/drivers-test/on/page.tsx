...
export const metadata: Metadata = {
  title: 'Ontario DriveTest Road Test Booking — AppointMe',
  description: 'Book your Ontario G2, G, M2 or M road test faster. We scan DriveTest.ca 24/7 and book the moment a cancellation appears. Pay only when we succeed.',
}
    ...
    <div className="min-h-screen bg-paper">
      ...
      <section className="max-w-6xl mx-auto px-6 py-4">
        <div className="bg-paper-warm rounded-2xl border border-ink/8 p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4 justify-between">
          <div>
            <p className="font-medium text-ink text-sm">Based in Vancouver or BC?</p>
            <p className="text-ink/45 text-sm mt-0.5">Early access is open for ICBC road test booking across Metro Vancouver.</p>
          </div>
          <Link href="/drivers-test/bc" className="btn-outline px-5 py-2.5 rounded-xl text-sm whitespace-nowrap shrink-0">
            BC early access →
          </Link>
        </div>
      </section>
